...
prokka ${basedir}/03_Assembly/Co-assembly-metaspades/contigs.fasta -outdir ${basedir}/04_Prokka/CB_metaspades --prefix CB_co_metaspades --locustag CB --metagenome --cpus 12 --kingdom Bacteria --centre X --compliant