...
#SBATCH --cpus-per-task=3                         # Number of CPUs per each MPI task
...
metawrap quant_bins -t 12 -o ${basedir}/12_Abundance/CB031_metaspade_abundance -b ${basedir}/09_Binning/CB031_metaspade/BIN_REFINEMENT/binsABC -a ${basedir}/03_Assembly/CB031_metaspade/contigs.fasta ${basedir}/02_Fastp/Clean_fastq/paired_reads/CB031/*.fastq
