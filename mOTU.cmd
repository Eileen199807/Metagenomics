...
unpair_dir="/lustre1/g/sph_pengwu/tutorial/2023_RIF_WGS_workshop/workshop3/Eileen/07_WGS_Meta/02_Fastp/Clean_fastq/unpaired_reads"
output_dir="/lustre1/g/sph_pengwu/tutorial/2023_RIF_WGS_workshop/workshop3/Eileen/07_WGS_Meta/15_mOTUs"

for SampleID in `cat sample.lst`
do
cd ${fastq_dir}/${SampleID}_remove_kraken
motus profile -f ${SampleID}_fastp_1.fq.gz -r ${SampleID}_fastp_2.fq.gz -s ${unpair_dir}/${SampleID}_fastp_unpaired_1.fastq.gz -k genus -t 12 > ${output_dir}/${SampleID}_taxonomy_profile_genus.txt
done

#Merge profiles
#motus merge -i CA034_taxonomy_profile_genus.txt,CB012_taxonomy_profile_genus.txt,CB014_taxonomy_profile_genus.txt,CB031_taxonomy_profile_genus.txt,CB038_taxonomy_profile_genus.txt,CB059_taxonomy_profile_genus.txt,CB158_taxonomy_profile_genus.txt,CB159_taxonomy_profile_genus.txt,CB161_taxonomy_profile_genus.txt,CB211_taxonomy_profile_genus.txt,CB646_131S_taxonomy_profile_genus.txt,CB646_212S_taxonomy_profile_genus.txt,CB711_taxonomy_profile_genus.txt,CB783_taxonomy_profile_genus.txt,CB850_taxonomy_profile_genus.txt,CB853_taxonomy_profile_genus.txt,CB895_taxonomy_profile_genus.txt,CB917_taxonomy_profile_genus.txt,CB918_taxonomy_profile_genus.txt,CB985_taxonomy_profile_genus.txt,CH010_taxonomy_profile_genus.txt,CH011_taxonomy_profile_genus.txt,CH015_taxonomy_profile_genus.txt,CX146_taxonomy_profile_genus.txt,CX149_taxonomy_profile_genus.txt,CZ033_taxonomy_profile_genus.txt,CZ050_taxonomy_profile_genus.txt,CZ120_taxonomy_profile_genus.txt,CZ121_taxonomy_profile_genus.txt -o HUM.motus
