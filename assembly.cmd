...
#SBATCH --time=1-10:00:00                         # Wall time limit (days-hrs:min:sec)
...
for SampleID in CB059
do
cd ${fastq_dir}/${SampleID}_remove_kraken
mkdir -o ${assemly_dir}/${SampleID}_megahit
time megahit -1 ${SampleID}_fastp_1.fq.gz -2 ${SampleID}_fastp_2.fq.gz -o ${assemly_dir}/${SampleID}_megahit --out-prefix ${SampleID}_megahit
done
