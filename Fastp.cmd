...
conda activate 05_AMR_metagenomics

# Setting path
fastq_dir='/lustre1/g/sph_pengwu/tutorial/2023_RIF_WGS_workshop/workshop3/Eileen/05_AMR_metagenomics'
outdir='/lustre1/g/sph_pengwu/tutorial/2023_RIF_WGS_workshop/workshop3/Eileen/07_WGS_Meta/02_Fastp/Clean_fastq'

# Write a loop for QC
for sampleID in `cat sample.lst`
do
fastp --in1 ${fastq_dir}/${sampleID}/${sampleID}_1.fq.gz --in2 ${fastq_dir}/${sampleID}/${sampleID}_2.fq.gz \
--out1 ${outdir}/paired_reads/${sampleID}_fastp_1.fastq.gz --out2 ${outdir}/paired_reads/${sampleID}_fastp_2.fastq.gz \
--unpaired1 ${outdir}/unpaired_reads/${sampleID}_fastp_unpaired_1.fastq.gz --unpaired2 ${outdir}/unpaired_reads/${sampleID}_fastp_unpaired_2.fastq.gz \
--detect_adapter_for_pe --dedup --dup_calc_accuracy 6 
done
